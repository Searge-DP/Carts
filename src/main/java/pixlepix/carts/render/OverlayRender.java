...
import pixlepix.carts.data.IToolTip;
...
public class OverlayRender {
    ...
    public void onScreenRenderEvent(RenderGameOverlayEvent event) {
        if (event.type == RenderGameOverlayEvent.ElementType.TEXT) {
            World world = LogisticsCarts.proxy.getWorld();
            EntityPlayer player = LogisticsCarts.proxy.getPlayer();
