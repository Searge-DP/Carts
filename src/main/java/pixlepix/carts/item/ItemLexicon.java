...
import pixlepix.carts.lexicon.CategoryManager;
import pixlepix.carts.lexicon.ILexiconable;
import pixlepix.carts.lexicon.LexiconEntry;
import pixlepix.carts.lexicon.common.core.helper.ItemNBTHelper;
import pixlepix.carts.registry.CraftingBenchRecipe;
import pixlepix.carts.registry.ITTinkererItem;
...
public class ItemLexicon extends Item implements ITTinkererItem {
        ...
        if (par2EntityPlayer.isSneaking()) {
            ...
            if (block != null) {
                if (block instanceof ILexiconable) {
                    ...
                    if (entry != null) {
                        LogisticsCarts.proxy.setEntryToOpen(entry);
                        LogisticsCarts.proxy.setLexiconStack(par1ItemStack);

                        par2EntityPlayer.openGui(LogisticsCarts.instance, 0, par3World, 0, 0, 0);
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
        ...
        LogisticsCarts.proxy.setLexiconStack(par1ItemStack);
        par3EntityPlayer.openGui(LogisticsCarts.instance, 0, par2World, 0, 0, 0);
