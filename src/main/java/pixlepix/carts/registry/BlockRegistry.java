...
public class BlockRegistry {
    ...
    public void registerClasses() {
        try {
            ...
            for (ClassPath.ClassInfo classInfo : classPath.getTopLevelClassesRecursive("pixlepix.carts.block")) {
            ...
            for (ClassPath.ClassInfo classInfo : classPath.getTopLevelClassesRecursive("pixlepix.carts.item")) {
