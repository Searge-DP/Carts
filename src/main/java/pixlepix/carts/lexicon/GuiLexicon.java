...
import pixlepix.carts.lexicon.button.GuiButtonBookmark;
import pixlepix.carts.lexicon.button.GuiButtonCategory;
import pixlepix.carts.lexicon.button.GuiButtonInvisible;
...
public class GuiLexicon extends GuiScreen {
    ...
    void drawHeader() {
        ...
        fontRendererObj.drawSplitString(String.format(StatCollector.translateToLocal("carts.gui.lexicon.header")), left + 18, top + 12, 110, 0);
