...
import pixlepix.carts.lexicon.button.GuiButtonBackWithShift;
import pixlepix.carts.lexicon.button.GuiButtonPage;
    ...
    public void updateScreen() {
        ...
        if (this.page == entry.pages.size() - 1) {
            ...
            if (entry == this.entry) {
                ...
                positionTutorialArrow();
                if (tutorial.isEmpty()) {
                    mc.thePlayer.addChatMessage(new ChatComponentTranslation("carts.tutorialEnded").setChatStyle(new ChatStyle().setColor(EnumChatFormatting.RED)));
